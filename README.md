...
2. Mount the Pi to the case and attach the breadboard and relay as shown in the image below, along with this place your GPIO breakout evenly on the breadboard
